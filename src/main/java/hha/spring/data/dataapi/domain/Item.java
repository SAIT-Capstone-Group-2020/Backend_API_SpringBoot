...
public class Item {
    ...
    public Item(int product_id, String product_name, String description, double sales_price, String image_url, String category_name, int quantity, double weight_value, String weight_type_name, String brand_name) {
